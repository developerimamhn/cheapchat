    ...
    return (
        <div className={` header ${scrolled ? "scrolled" : " "} z-[150] w-full header backgronsdvg${
            ...
            <Link onClick={(e) => handleScrollToTop(e, "")} href='#' className='cursor-pointer relative flex  items-center justify-start Froggo-Logo'>
                <Image className='w-[40px] md:w-[48px] lg:w-[70px] xl:w-[110px] 2xl:w-[140px]' src={logo} alt=''/></Link>
                 

                
                
                <ul className='sm:flex hidden gap-[10px] sm:gap-[11px] md:gap-[12px] lg:gap-[13px] xl:gap-[14px] 2xl:gap-[15px] ml-atuo'>
                <button className='rounedourtext  cursor-pointer flex items-center justify-center py-[11px] sm:py-[12px] md:py-[13px] lg:py-[14px] xl:py-[15px] 2xl:py-[16px] group gap-[7.50px] px-[14px] sm:px-[15px] md:px-[16px] lg:px-[20px] xl:px-[24px] 2xl:px-[29px] text-[16px] sm:text-[20px] md:text-[24px] lg:text-[32px] xl:text-[36px] 2xl:text-[40px]'>
                ...
                <button className='w-[90px] h-[90px] rounedourtext flex items-center justify-center '>
                    <svg className='w-[24px] sm:w-[32px] md:w-[36px] lg:w-[40px] xl:w-[48px] 2xl:w-[50px]' viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className='w-[90px] h-[90px] rounedourtext blur-3xl flex items-center justify-center '>
