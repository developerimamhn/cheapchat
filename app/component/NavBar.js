...
const NavBar = () => {
    ...
    return (
        <div className={` header ${scrolled ? "scrolled" : " "} z-[150] w-full header backgronsdvg${
            ...
            <Link onClick={(e) => handleScrollToTop(e, "")} href='#' className='cursor-pointer  relative flex  items-center justify-start Froggo-Logo select-none pointer-events-none'>
                ...
                <button className='rounedourtext  cursor-pointer flex items-center justify-center py-[11px] sm:py-[12px] md:py-[13px] lg:py-[14px] xl:py-[15px] 2xl:py-[16px] group gap-0.5 sm:gap-[7.50px] px-[14px] sm:px-[15px] md:px-[16px] lg:px-[20px] xl:px-[24px] 2xl:px-[29px] text-[10px] sm:text-[20px] md:text-[24px] lg:text-[32px] xl:text-[36px] 2xl:text-[40px] backdrop-blur-[50px] '>
                   <span className='rounedourtextbtn leading-[70.499%] sm:leading-[96.499%] pl-[14px] sm:pl-[15px] md:pl-[16px] lg:pl-[20px] xl:pl-[24px] 2xl:pl-[29px]'> БЕСПЛАТНЫЙ</span><span>⭐️</span>
                </button>
                <button className='w-[35] sm:w-[48px] xl:w-[64px] 2xl:w-[90px] h-[35] sm:h-[48px] xl:h-[64px] 2xl:h-[90px] rounedourtext flex items-center justify-center '>
                    <svg className='w-[17px] sm:w-[32px] md:w-[36px] lg:w-[40px] xl:w-[48px] 2xl:w-[50px]' viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className='w-[35] sm:w-[48px] xl:w-[64px] 2xl:w-[90px] h-[35] sm:h-[48px] xl:h-[64px] 2xl:h-[90px] rounedourtext flex items-center justify-center '>
                    <svg xmlns="http://www.w3.org/2000/svg" className='w-[17px] sm:w-[32px] md:w-[36px] lg:w-[40px] xl:w-[48px] 2xl:w-[50px]' viewBox="0 0 50 50" fill="none">
